# The Long Story about TiddlyRAG

## Perspective 1: The development of LLM ecosystem feels wrongs to me

As open source stan, I won't believe performance of close source "Model", until I saw the open weight, who knows? Maybe it's a huge RAG system behind the API.
...
![](./01_knowledge-reuse.webp)

## Extra Perspective: Scenario of Lazy Domain Expert
